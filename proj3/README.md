...
#### 1. podúkol
Stáhněte si kostru programu [proj3.c](https://wis.fit.vutbr.cz/FIT/st/cwk.php?title=Projekt3&src=Proj3.c&ns=IZP&&action=fileinfo&csid=678740&id=12816). Seznamte se s datovými typy a funkcemi. Vaším úkolem je pouze doplnit kód na místech označených komentářem TODO.
...
==23223== Copyright (C) 2002-2017, and GNU GPL, by Julian Seward et al.
